...
function checkEvenOrOdd(number3 :number):string{
 ...
 function calculateArea(length:number , width:number):string{
    let sol : number =length * width;
    return`Area of Rectangle = ${sol}`;
 }
console.log(calculateArea(34,56))
// Scenario 3 
// Reversing string
function reverseString (str3:string){
...
function convertCelsiusToFahrenheit (temprature : number){
    let fahrenheitTemp ;
    if(temprature>0){
...
let array : string[]=['C++' , 'Java' , 'Python' , 'Javascript' , 'Ruby'];
console.log(array)
// using push() method
...
//- **Scenario 2 - Subarray Creation:**
    ...
    console.log(array);
    // creating a subarray named newarr
